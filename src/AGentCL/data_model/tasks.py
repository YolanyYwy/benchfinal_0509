...
class EvaluationCriteria(BaseModel):
    ...
    # 用于 instore/delivery/ota 等 domain 的评估标准
    expected_states: Annotated[
        Optional[list[dict]],
        Field(
            description="Expected states for trajectory evaluation. Each state contains required_orders, optional_orders, and state_rubrics.",
            default=None,
        ),
    ]
    ...
    overall_rubrics: Annotated[
        Optional[list[str]],
        Field(
            description="Overall rubrics for the task evaluation.",
            default=None,
        ),
    ]
